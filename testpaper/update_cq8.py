...
<svg viewBox="-180 -160 360 340" width="100%" style="max-width: 400px; font-family: sans-serif;" xmlns="http://www.w3.org/2000/svg">
  <!-- Outer Circle -->
  ...
  <g stroke="#1f2937" stroke-width="3">\n"""
    ...
    # Texts
    labels = ["A", "Organizing", "Staffing", "Directing", "Motivating", "F", "Controlling"]
    ...
    for i in range(7):
        ...
        font_size = "13" if len(labels[i]) > 8 else "15"
        if labels[i] in ["A", "F"]:
            font_size = "24"
            font_weight = "bold"
        else:
    ...
    svg += '  <text x="0" y="160" font-size="16" font-weight="bold" fill="#111827" text-anchor="middle" dominant-baseline="middle">Management Cycle</text>\n'
...
def process():
    ...
    if array_start != -1:
        ...
        print("Successfully updated CQ 08 with English SVG.")
    else:
