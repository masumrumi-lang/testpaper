...
<svg viewBox="-180 -160 360 340" width="100%" style="max-width: 350px; font-family: sans-serif;" xmlns="http://www.w3.org/2000/svg">
  <!-- Outer Circle -->
  ...
  <g stroke="#1f2937" stroke-width="3">\n"""
    ...
    # Texts
    labels = ["Planning", "Organizing", "Staffing", "Directing", "?", "Coordinating", "Controlling"]
    ...
    svg += '  <text x="0" y="160" font-size="16" font-weight="bold" fill="#111827" text-anchor="middle" dominant-baseline="middle">Figure: Management Function Cycle</text>\n'
...
def process():
    ...
    if array_start != -1:
        ...
        print("Successfully updated CQ 28 with English SVG.")
    else:
