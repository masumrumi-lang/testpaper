...
def process():
    ...
    if array_start != -1:
        ...
        questions_text = {
            "a": '(a) What is management? (1)',
            "b": "(b) Why is a supervisor called a lower-level manager? (2)",
            "c": "(c) At which level of management is Ms. Maliha positioned in the stem? Explain. (3)",
            "d": '(d) "There is no difference in managerial skills between the work of Mr. Shihan and Ms. Maliha in the stem" - give your opinion. (4)'
        }
        ...
        print("Successfully updated missing questions for CQ 16.")
    else:
