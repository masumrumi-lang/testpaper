...
mcq_source_path = r'c:\Users\BMTF\.antigravity\testpaper\acc1_ch6_mcq.js'

# Read MCQ source
with open(mcq_source_path, 'r', encoding='utf-8') as f:
    mcq_raw = f.read()
    # Extract the array content
    mcq_match = re.search(r'\[(.*)\]', mcq_raw, re.DOTALL)
    if not mcq_match:
        print("Could not parse mcq source")
        exit(1)
...
# Locate Chapter 7 start (to define end of Ch 6)
...
print("Restored Chapter 6 MCQs and updated Full CQs successfully")
