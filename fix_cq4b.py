...
old_answer = "\"<p class='text-xs'>Accum Dep Bal Dec 31, 2024 = 14,500 + 8,550 + 15,195 = 38,245. Ledgers follow standard dual-entry format closing to income summary.</p>\""
...
new_answer = '''"<div class='space-y-4 font-mono'>
    ...
    <table class='w-full text-[10px] border-collapse border border-gray-300'>
      ...
      <tbody>
        <tr>
          ...
          <td class='border border-gray-300 p-1 text-right'>8,550</td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1 text-right'>8,550</td>
        ...
        <tr>
          ...
          <td class='border border-gray-300 p-1'>Accumulated Depreciation A/C</td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1 text-right'>15,195</td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1 text-right'>15,195</td>
          <td class='border border-gray-300 p-1 text-center'></td>
        </tr>
  ...
  <div class='overflow-x-auto'>
    <table class='w-full text-[10px] border-collapse border border-gray-300'>
      ...
      <tbody>
        <tr>
          <td class='border border-gray-300 p-1'>2023<br>Jan. 1</td>
          <td class='border border-gray-300 p-1'>Balance</td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1 text-right'>14,500</td>
        </tr>
        <tr>
          ...
          <td class='border border-gray-300 p-1 text-right'>8,550</td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1 text-right'>23,050</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class='border border-gray-300 p-1 text-right'>15,195</td>
          <td class='border border-gray-300 p-1'></td>
          <td class='border border-gray-300 p-1 text-right'>38,245</td>
        </tr>
      </tbody>
    </table>
  </div>
...
if old_answer in content:
    ...
    with open('data.js', 'w', encoding='utf-8') as f:
        f.write(content)
    print("Successfully replaced CQ4(b) answer!")
else:
    print("Could not find the exact old string. Checking for partial match.")
    idx = content.find("Accum Dep Bal Dec 31, 2024 = 14,500 + 8,550 + 15,195 = 38,245.")
    if idx != -1:
