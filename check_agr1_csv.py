            ...
            for row in reader:
                ...
                for field_val in [question, explanation, opt_a, opt_b, opt_c, opt_d]:
                    if 'imes' in field_val and '\\times' not in field_val:
                        # Could be a false positive (e.g. "times"), but in this context usually a typo
                        if not re.search(r'[a-zA-Z]times', field_val):
                             # matches " imes" or start of string
...
if __name__ == "__main__":
    filepath = r"c:\Users\BMTF\.antigravity\testpaper\agriculture1_FINAL_CLEANED.csv"
